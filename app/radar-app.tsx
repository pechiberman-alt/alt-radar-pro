...
export default function RadarApp() {
  ...
  <PumpRadar
        ...
        <Collapsible id="spot" label="ESTRATEGIA SPOT" open={workspace.open["spot"]} onToggle={workspace.toggle}>
          <SpotDesk />
        </Collapsible>
        ...
        <Collapsible id="configuracion" label="CONFIGURACIÓN" open={workspace.open["configuracion"]} onToggle={workspace.toggle}>
          <SettingsDesk />
        </Collapsible>
        ...
        <Collapsible id="ordenes-grandes" label="ÓRDENES GRANDES" open={workspace.open["ordenes-grandes"]} onToggle={workspace.toggle}>
          <BigTradesDesk />
        </Collapsible>
